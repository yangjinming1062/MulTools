...
namespace MulTools.Components
{
    ...
    public class SidePanel : UserControl
    {
        ...
        protected virtual void OnRequestClosing() => RequestClosing?.Invoke(this, EventArgs.Empty);
        ...
        public virtual void OnFirstShown(Monitor form) => ParentMainForm = form;

        /// <summary>
        /// Is called before removing the side panel.
        /// </summary>
        /// <param name="form">Parent form that is embedding the side panel.</param>
        public virtual void OnClosing(Monitor form) { }
